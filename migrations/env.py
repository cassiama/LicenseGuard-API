...
# Import our DB_URL variable (if it exists) and set our SQLAlchemy URL to that.
db_url = os.environ.get("DB_URL", "")
if db_url:
    config.set_main_option("sqlalchemy.url", db_url)
if not config.get_main_option("sqlalchemy.url", db_url):
    raise RuntimeError("DB_URL is empty or not set. Alembic cannot be run.")

# These lines import and set up our models
...
from srv.schemas import SQLModel
